...
select count(*) from aip_message_persistence;
drop view aip_message;
rename aip_message_persistence to aip_message;
rename aip_message to aip_message_persistence;
...
select count(*) from aip_message_persistence;
update  aip_message_persistence set serv_id=801;
select *
