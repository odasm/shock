create or replace view aip_message_test as
select
...
a.msg_size msg_size,s.serv_id,b.response_time response_time,b.send_time send_time,
nvl(b.service_state,a.service_state) service_state
